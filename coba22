...
with st.sidebar.form("input_form"):
    ...
    rec_t = st.number_input("Receivables (t)", value=14292.0)
    ...
    sga_t = st.number_input("SGA Expense (t)", value=69046.0)
    ...
    rec_t1 = st.number_input("Receivables (t-1)", value=10944.0)
    ...
    sga_t1 = st.number_input("SGA Expense (t-1)", value=61591.0)
